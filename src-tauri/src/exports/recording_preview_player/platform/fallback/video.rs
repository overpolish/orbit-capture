...
//! FFmpeg playback decode for platforms without a native video path.
//!
//! Frames arrive as MJPEG over a pipe and are forwarded to the webview as
//! `Composite` payloads, which the DOM/canvas preview draws itself.
